<template>
    <div>
        <map-component v-if="map && markers" :map_id="map.uuid" :map_token="map_token" style="height: 65vh;" :users_can_create_incidents="map.users_can_create_incidents" :map_categories="map.categories" :initial_incidents="activeMarkers"></map-component>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="show_all_checkbox">
                                                Show markers that have expired
                                            </label>
                                        </div>
                                    </div>
                                </div>

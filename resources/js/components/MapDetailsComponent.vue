<template>
    <div class="row">
        <div class="col-md-7">
            ...
            <p v-if="(!map || !map.description) && canEdit" :contenteditable="canEdit" @input="handleSelectInput($event, 'description')">Right click (or long-tap on mobile) on the map to add markers. Click here to edit the map description.</p>

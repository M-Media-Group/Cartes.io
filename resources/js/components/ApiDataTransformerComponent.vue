    ...
    <div class="col-12 mt-5 mt-md-0">
      <div class="card bg-dark text-white mb-3" key="map-settings">
        <div
          ...
          data-target="#settingsImportCollapse"
          aria-expanded="false"
          aria-controls="settingsImportCollapse"
          style="cursor: pointer"
        >
          <i class="fa fa-cog"></i> Data importer
        </div>
        <div class="card-body collapse" id="settingsImportCollapse">
          <div class="form">
            ...
            <button type="url" class="btn btn-primary mb-2" @click="getData()">
              Fetch JSON data
            </button>
          </div>
          ...
          <details class="mt-3 mb-3">
            ...
            <div>
              ...
              ><code>{{first_data_point}}</code></pre>
            </div>
          </details>
          <hr />
          <details class="mt-3 mb-3">
            ...
            <div>
              <input
                v-model="transform_parameters.container"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.id"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.location.lat"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.location.lng"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.category_name"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.created_at"
                type="text"
                class="form-control"
                id="inputPassword2"
              ...
              />
              <input
                v-model="transform_parameters.updated_at"
                type="text"
                class="form-control"
                id="inputPassword2"
          ...
          <details class="mt-3 mb-3">
            ...
            <div>
              <pre
                class="text-white small"
              ><code v-if="transformed_data">{{transformed_data[0]}}</code></pre>
            </div>
          </details>
        </div>
      </div>

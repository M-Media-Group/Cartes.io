...
@section('content')
    ...
    @if (!Auth::user()->hasVerifiedEmail())
        <div class="card text-dark">
            {{-- <img class="card-img-top" src="/images/correct-mapping-1.jpg" alt="Card image"> --}} <div class="card-body">
                <h5 class="card-title"><b>Confirm your email address</b></h5>
                <p class="card-text">You won't be able to do much until you confirm your email address. Click the link
                    we sent you.</p>
            </div>
        </div>
    @endif
    <div class="card bg-dark text-white mt-5">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Report exactly where the marker should be. Zoom in all the way for the best accuracy.
            </p>
    ...
    <div class="card bg-dark text-white mt-5">
        ...
        <div class="card-body">
            <h5 class="card-title">Be respectful of the law and <b>don't report locations if it breaks local laws,
                    reveals classified or sensitive information, and/or causes more harm than good</b></h5>

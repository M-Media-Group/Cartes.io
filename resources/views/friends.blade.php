...
@section('above_container')
    <div class="jumbotron jumbotron-fluid d-flex align-items-center"
        ...
        <div class="container mt-4 mb-3">
            ...
            <p class="lead">Whether its marking places to visit for out-of-town friends or marking possible spots
...
@section('content')
    ...
    <div class="row mb-5 mt-5 align-items-center">
        ...
        <div class="col-md-6">
            ...
            <p>Press the share button to share the map with your friends. By default, only people with a link can see your
                map.</p>
        </div>
    </div>
@endsection

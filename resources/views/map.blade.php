...
@section('above_container')
    ...
    <map-container-component :initial_map="{{ $map }}" initial_map_token="{{ $token }}"
        :user="{{ Auth::user() ?? '{}' }}"></map-container-component>
...
@section('content')
    ...
    @if ($token)
        <div class="modal fade" style="background: linear-gradient(rgba(28,119,195, 0.2), var(--white));"
            ...
            <div class="modal-dialog modal-dialog-centered modal-dark" role="document">
                <div class="modal-content bg-dark">
                    ...
                    <div class="modal-body">
                        ...
                        <p>Scroll down a bit and click on "Map settings" to edit privacy and marker expiration times. Don't
                            forget to edit the title and description too!</p>
                    </div>

...
<h1 style="display: none;">{{config('app.name')}}</h1>
	...
	@if($token)
		<div class="modal fade" style="background: linear-gradient(rgba(28,119,195, 0.2), var(--white));z-index: 1003;" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

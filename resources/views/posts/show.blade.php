...
@section('sidebar')
    ...
    @can('delete', $post)
        ...
        <hr>
    @endcan
    <p><a href="/users/{{ $post->user->username }}"><img class="rounded img-thumbnail mr-1" src="{{ $post->user->avatar }}"
                height="45" width="45" alt="{{ $post->user->username }}"
                title="{{ $post->user->username }}">{{ $post->user->username }}</a></p>
    ...
    <hr>
    @foreach ($post->categories as $category)
        <a href="/categories/{{ $category->slug }}"><img class="rounded img-thumbnail mr-1" height="30" width="30"
                src="{{ $category->icon }}" title="{{ $category->name }}"
...
@section('above_container')
    ...
    <img src="{{ $post->header_image }}" title="{{ $post->title }}" style="height: 63vh;object-fit:cover;width:100%;"
        alt="{{ $post->title }}">
